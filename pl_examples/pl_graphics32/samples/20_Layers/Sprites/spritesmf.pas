...
begin
  ...
  try
    ...
    BitmapList.Bitmap[0].LoadFromfile(pathMedia+ 'sprite1.bmp');
    TempBitmap.LoadFromfile(pathMedia+'sprite1a.bmp');
    IntensityToAlpha(BitmapList.Bitmap[0], TempBitmap);

    BitmapList.Bitmap[1].LoadFromfile(pathMedia+'sprite2.bmp');
    TempBitmap.LoadFromfile(pathMedia+'sprite2a.bmp');
    IntensityToAlpha(BitmapList.Bitmap[1], TempBitmap);

    BitmapList.Bitmap[2].LoadFromfile(pathMedia+'sprite3.bmp');
    TempBitmap.LoadFromfile(pathMedia+'sprite3a.bmp');
...
begin
  TimerFPS.Enabled := False;
  TimeElapsed := GetTickCount64 - LastCheck;
