...
uses
   fpcunit, testregistry,  Controls, Types, Classes, SysUtils, Messages, Graphics,
...
initialization
  RegisterTest(TTestBlendModesNative);
  {
  if ciMMX in CPUFeatures then
    RegisterTest(TTestBlendModesMMX);
  if ciSSE2 in CPUFeatures then
    RegisterTest(TTestBlendModesSSE2); }
