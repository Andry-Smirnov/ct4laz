...
uses
  ...
  GR32_Resamplers, GR32_Layers,GR32_Polygons, GR32_RangeBars;
...
type
  ...
  TFormTranformExample = class(TForm)
    ...
    procedure SrcRBResizingEvent(Sender: TObject; const OldLocation: TFloatRect; var NewLocation: TFloatRect; DragState: TRBDragState; Shift: TShiftState);
...
begin
  ...
  try
    JPEG.LoadFromfile(pathMedia+'typhon.jpg');
...
procedure TFormTranformExample.SrcRBResizingEvent(Sender: TObject; const OldLocation: TFloatRect; var NewLocation: TFloatRect; DragState: TRBDragState; Shift: TShiftState);
begin
  Src.Invalidate;
  DoTransform;
end;
