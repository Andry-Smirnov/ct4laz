...
const
  ...
  subjBrushColor: TColor32 =clTrRed32; // $00DDDDF0;
  clipPenColor: TColor32 = $30F9BEA6;
  clipBrushColor: TColor32 = clFuchsia32;//$00FFE0E0;
  solPenColor: TColor32 = $7F003300;
  solBrushColor: TColor32 = clLime32;//$8066EF7F;
...
begin
 ...
 // if (GetAsyncKeyState(VK_LBUTTON) < 0) then exit;  // 9999
...
begin
  ...
  begin
    ...
    begin
     ...
     // clip[i] := GetEllipsePoints(rec);    // 9999
    end;
  end;
