...
uses
  ...
  GR32, GR32_Blend, GR32_Filters, GR32_Image,
  GR32_LowLevel,  GR32_MicroTiles, GR32_Rasterizers,
  GR32_Resamplers, GR32_System, GR32_Layers,

  VGR32_Misc, VGR32_Lines, Math, ExtCtrls,
  ComCtrls, Messages, LMessages;
...
procedure TForm1.OnShortCut(var Msg: TLMKey; var Handled: Boolean);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    DrawText(Image.Bitmap.Canvas.handle, 'TLine32', 7,
  ...
  case btnState of
    bsHighlight:
      begin
        ...
        DrawText(Image.Bitmap.Canvas.handle,
