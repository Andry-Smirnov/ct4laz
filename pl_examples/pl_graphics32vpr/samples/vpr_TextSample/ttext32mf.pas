...
uses
  windows,
  LCLIntf, LCLType, LMessages, Types, SysUtils, Classes, Graphics, Controls, Forms, Dialogs, Math,
  StdCtrls, ExtCtrls,
  LResources,

  GR32, GR32_Blend, GR32_Filters, GR32_Math,
  GR32_LowLevel,  GR32_MicroTiles, GR32_Rasterizers,
  GR32_Resamplers, GR32_System, GR32_Image, GR32_Layers, GR32_Polygons,

  VGR32_Misc, VGR32_Lines,VGR32_Text, ComCtrls;
...
begin
  ...
  VGR32_Text.Text32LCDDrawDefault := fontSmoothingEnabled;
...
begin
  ...
  if PageControl1.ActivePage = TabSheet4 then
    lblRotation.Caption := format('%dΊ',[Constrain(sbRotation.Position, -45, 45)]) else
    lblRotation.Caption := format('%dΊ',[sbRotation.Position]);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  try
    Skew(sbSkewX.Position/10, 0);
    polyPts := GetBetweenPaths(lowerPts,upperPts,'  CodeTyphon  ',ttfc96);
  finally
    free;
  end;
