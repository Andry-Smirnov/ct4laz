...
function AllocateMemoryCallback(aUserData:PVkVoid;
                                aSize:TVkSize;
                                aAlignment:TVkSize;
                                aScope:TVkSystemAllocationScope):PVkVoid; vkExtdecl;
begin
...
procedure FreeMemoryCallback(aUserData:PVkVoid; aMemory:PVkVoid); vkExtdecl;
begin
...
procedure InternalAllocationCallback(aUserData:PVkVoid;
                                     ...
                                     aScope:TVkSystemAllocationScope); vkExtdecl;
begin
...
function vkuDebugReportCallback(flags:TVkDebugReportFlagsEXT;
                                ...
                                pUserData:PVkVoid):TVkBool32; vkExtdecl;
var ret:Boolean;
begin
...
begin
  ...
  if (Length(aMemoryBarriers)=0)       or
     (Length(aBufferMemoryBarriers)=0) or
     (Length(aImageMemoryBarriers)=0)  then
    ...
    DeviceFunctions.vkCmdPipelineBarrier(
                                         ...
                                         aDstStageMask,
                                         aDependencyFlags,
                                         Length(aMemoryBarriers),
                                         @aMemoryBarriers,
                                         Length(aBufferMemoryBarriers),
                                         @aBufferMemoryBarriers,
                                         Length(aImageMemoryBarriers),
                                         @aImageMemoryBarriers);
end;
