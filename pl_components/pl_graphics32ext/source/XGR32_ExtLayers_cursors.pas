...
uses
 ...
 {$IFDEF MSWINDOWS} Windows, {$ENDIF}
  LCLIntf, LCLType, LMessages, Graphics, Types,
  Controls;
...
procedure LoadExtLayersCursors; // ct9999 for CodeTyphon

implementation

{$IFDEF MSWINDOWS}
  {$R XGR32_ExtLayers_cursors.res}
{$ENDIF}
...
procedure LoadExtLayersCursors;
var  Win2K: Boolean;
begin
