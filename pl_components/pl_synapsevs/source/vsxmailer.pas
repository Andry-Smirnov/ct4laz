...
procedure SendMail(const S: string; AArgs: array of const; const AQuoteChar: Char = '"'; AProgress: TMailerProgress = nil);
procedure SendMail(const AParams: string; const AQuoteChar: Char = '"'; AProgress: TMailerProgress = nil);
