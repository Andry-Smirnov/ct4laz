...
{ -------------------------------------------------------------------------- }
procedure DESEncryptStreamCBCPEM(InStream, OutStream : TStream; const Key : TKey64; const IV : TDESBlock; Encrypt : Boolean);
var
  i          : Longint;
  Block      : TDESBlock;
  PrevBlock  : TDESBlock;
...
{ -------------------------------------------------------------------------- }
procedure TripleDESEncryptStreamCBCPEM(InStream, OutStream : TStream; const Key1, Key2, Key3 : TKey64; const IV : TDESBlock;
            Encrypt : Boolean);
var
  i          : LongInt;
  Block      : TDESBlock;
