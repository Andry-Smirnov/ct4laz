...
function BezierCurveToPolygonX(const Vertices: TArrayOfBezierVertex; Closed: boolean = True): TArrayOfFixedPoint; overload;
function BezierCurveToPolygonF(const Vertices: TArrayOfBezierVertex; Closed: boolean = True): TArrayOfFloatPoint; overload;
...
{ Text routines }
procedure DrawText(Dst: TBitmap32; X, Y: TFloat; const Text: WideString; OutlineColor, FillColor: TColor32;
  Transformation: TTransformation = nil); overload;
procedure DrawText(Dst: TBitmap32; X, Y: TFloat; const Text: WideString; OutlineColor: TColor32; Filler: TCustomPolygonFiller;
  Transformation: TTransformation = nil); overload;
procedure DrawTextOutline(Dst: TBitmap32; X, Y: TFloat; const Text: WideString; Color: TColor32; Transformation: TTransformation = nil);
procedure FillText(Dst: TBitmap32; X, Y: TFloat; const Text: WideString; Filler: TCustomPolygonFiller; Transformation: TTransformation = nil);
...
function MakeCurve(const Points: TArrayOfFloatPoint; Kernel: TCustomKernel; Closed: boolean; StepSize: integer): TArrayOfFixedPoint; overload;
...
begin
  Result :=
    Abs(P1.X + P3.X - 2 * P2.X) + Abs(P1.Y + P3.Y - 2 * P2.Y) + Abs(P2.X + P4.X - 2 * P3.X) + Abs(P2.Y + P4.Y - 2 * P3.Y);
end;
...
function BezierCurveToPolygonX(const Vertices: TArrayOfBezierVertex; Closed: boolean = True): TArrayOfFixedPoint;
var
  I, Index: integer;
...
function BezierCurveToPolygonF(const Vertices: TArrayOfBezierVertex; Closed: boolean = True): TArrayOfFloatPoint;
var
  I, Index: integer;
...
function GlyphOutlineToBezierCurve(Dst: TBitmap32; DstX, DstY: TFloat; const Glyph: integer; out Metrics: TGlyphMetrics): TBezierCurve;
var
  I, J, K, S, Res: integer;
  Code: longword;
...
begin
  ...
  try
    ...
    begin
      ...
      OSInteger(PPCurve) := OSInteger(PBuffer) + SizeOf(TTTPolygonHeader);
      ...
      begin
        ...
        Dec(S, K);
        Inc(OSInteger(PPCurve), K);
      end;

      Dec(OSInteger(PPCurve), K);
      ...
      Dec(Res, PBuffer.cb);
      Inc(OSInteger(PBuffer), PBuffer.cb);
    end;
...
procedure RenderText(Dst: TBitmap32; X, Y: TFloat; const Text: WideString; OutlineColor, FillColor: TColor32;
  FillCallback: TFillLineEvent; Transformation: TTransformation = nil);
var
  P: TPolygon32;
begin
...
function MakeCurve(const Points: TArrayOfFixedPoint; Kernel: TCustomKernel; Closed: boolean; StepSize: integer): TArrayOfFixedPoint; overload;
var
  I, J, F, H, Index, LastIndex, Steps, R: integer;
  K, V, W, dx, dy, X, Y: single;
  Filter: TFilterMethod;
