...
uses
  ...
  GR32_LowLevel, GR32_MicroTiles,
  GR32_Polygons, GR32_Rasterizers,
  GR32_Resamplers, GR32_System, GR32_Transforms,
  GR32_VectorUtils,
  VGR32_PolygonsEx;
...
procedure TPathRenderer.SetStrokeDashArray(const DashArray: array of TFloat);
var
  L: integer;
