...
uses LCLIntf, LCLType, LMessages,
     cyClasses, cyBaseLabel,  Classes, ExtCtrls, Controls, Messages, Graphics;
...
procedure TcyCustomHotLabel.CmMouseEnter(var Msg: TLMessage);
begin
...
procedure TcyCustomHotLabel.CmMouseLeave(var Msg: TLMessage);
begin
  if not (csDesigning in ComponentState)
  then begin
    FlabelFocused := false;
