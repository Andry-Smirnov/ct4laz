...
uses LCLIntf, LCLType, LMessages,
     Classes,  Types, Controls, Graphics, Messages, ExtCtrls, cyTypes, cyClasses, cyBaseColorMatrix;
...
type
  ...
  protected
    procedure DrawBackground(const Rect: TRect); override;
...
procedure TcyCustomColorMatrix.DrawBackground(const Rect: TRect);
var
  TmpRect: TRect;
begin
  ...
  begin
    TmpRect := Rect;
    FBevels.DrawBevels(Canvas, TmpRect, false);
  end;
end;
