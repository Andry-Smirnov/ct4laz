...
uses  LCLIntf, LCLType, LMessages,
      Classes, Controls, StdCtrls, SysUtils, DateUtils, cyEdit;
...
type
  ...
  private
    ...
    FMinValue: TDate;
    FMaxValue: TDate;
    procedure CMExit(var Message: TLMessage); message CM_EXIT; //=== ct9999 ===
...
var
  ...
  DateSymbol: String;
begin
  if (Value <> 0) or (not AllowEmpty) then      // 2018-04-10
  begin
...
function TcyEditDate.ValidateValue(aText: String): TEditValidateResult;
var
  StrYear, StrMonth, StrDay: String;
  Year, Month, Day: Integer;
  Rslt: TDate;
...
procedure TcyEditDate.CMExit(var Message: TLMessage); //=== ct9999 ===
var
  DefaultValue: TDate;
  StrYear, StrMonth, StrDay: String;
  SavModified: Boolean;
begin
  ...
  begin
    ...
    Inherited CMExit(Message); //=== ct9999 ====
end;
