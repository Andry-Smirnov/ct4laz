...
{$IFDEF DELPHI2009}
  // Adjust client rect of the tabcontrol:
...
begin
  ...
  begin
    ...
    Images.Draw(Canvas2, aGraphicX, aGraphicY, Tab);
  end
  else
    TextRect := aRect;

  if Tab = TabIndex
  then DoDrawTabStyleCaption(Canvas2, Tab, tabs[Tab], TextRect, FActiveTabFont)
  else DoDrawTabStyleCaption(Canvas2, Tab, tabs[Tab], TextRect, FInactiveTabFont);
end;
