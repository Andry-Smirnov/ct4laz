...
uses 
    ...
    cyClasses, cyTypes, cyAdvPanel, Graphics, classes, Messages, Controls, SysUtils,
    Types;
...
type
  ...
  protected
    procedure WndProc(var Message: TLMessage); override; // ct9999
...
procedure TcyNavPanel.WndProc(var Message: TLMessage);     // ct9999
var
  aControl: TControl;
  ScreenPos: TPoint;
...
begin
  ...
  if Message.Msg = WM_LBUTTONUP then // Only works for TGraphicControls ...    // ct9999
  begin
    AllowDisabled := true;
    aControl := Self.ControlAtPos(SmallPointToPoint(TLMMouse(Message).Pos), AllowDisabled, true);   // ct9999
