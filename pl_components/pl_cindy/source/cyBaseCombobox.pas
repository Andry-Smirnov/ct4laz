...
uses
    ...
    Classes, Messages, SysUtils, Forms, Controls, StdCtrls, cyTypes, cyBaseContainer, cyFlyingContainer;
...
begin
  ...
  FTagStr := '';
  FDropDownWidth := 0;
  SavTickCountCloseUp := GetTickCount64;
...
begin
  ...
  FFlyingContainer.ExecuteFromControl(Self, OffsetLeft, OffsetTop);
end;
...
begin
  ...
  begin
    ...
    if GetTickCount64 - SavTickCountCloseUp >= 200 then   // Works between 100 and 300 ms ...
      DoDropDownControl;
  end
  else begin
...
procedure TcyBaseCombobox.WMLButtonDown(var Message: TLMLButtonDown);
begin
