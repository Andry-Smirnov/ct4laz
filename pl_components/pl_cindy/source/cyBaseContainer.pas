...
uses
    ...
    Classes, Forms, Graphics, Messages, SysUtils, Controls, Types, Grids;
...
begin
  ...
  if DontActivate then
    SendMessage(TWinControl(Self.Owner).Handle, LM_NCACTIVATE, Ord(Msg.Active <> WA_INACTIVE), 0);
...
procedure TcyBaseContainer.DoFormKeyPress(var Key: Char);
 //--- ct9999 --------------------
      ...
      begin
        ...
        //if Result then
        //  onForm.Perform(LM_NEXTDLGCTL, 0, 0);
      end;
 //-------------------------------
begin
