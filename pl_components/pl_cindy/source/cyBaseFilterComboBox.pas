...
uses
     ...
     Classes, Messages, Forms, SysUtils, Graphics, Controls, StdCtrls, cyStrUtils, cyFlyingContainer, cyBaseCombobox, cyPanel, cyEdit;
...
begin
  ...
  begin
    ...
    begin
      MatchFilterItemIndex := FListBox.Items.IndexOf(SaveSelectedText);   // Select previous selected text by default !!!
