...
TCustomPanelExt = class(TCustomPanel)
  ...
  private
    ...
    procedure WMWindowPosChanged(var Message: TLMWindowPosChanged); message LM_WINDOWPOSCHANGED; // ct9999
...
procedure TCustomGridPanel.WMWindowPosChanged(var Message: TLMWindowPosChanged); // ct9999
begin
  inherited;
  FRecalcCellSizes := True;
end;
