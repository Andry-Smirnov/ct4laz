...
begin
  ...
  if (Value >= 0) or (not AllowEmpty) then      // 2018-04-10   0 = mi-nuit ...
  begin
...
function TcyEditTime.ValidateValue(aText: String): TEditValidateResult;
var
  StrHour, StrMin, StrSec: String;
  Hour, Min, Sec: Integer;
begin
...
procedure TcyEditTime.CMExit(var Message: TLMessage); //=== ct9999 ===
var
