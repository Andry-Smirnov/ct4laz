...
uses
  ...
  Classes, Messages, Controls, Forms, SysUtils, Inifiles, Registry, ExtCtrls, Graphics,
  cyImage;
...
type
  ...
  TIniDirectory = (idProgramLocation, idCommonAppData, idLocalAppData, idUserDataDir);
  ...
  private
    ...
    FDefinitionsSaved: Boolean;
    FDefinitionsLoaded: Boolean;
  ...
  public
    ...
    property DefinitionsLoaded: Boolean read FDefinitionsLoaded;
    property DefinitionsSaved: Boolean read FDefinitionsSaved;
  published
...
WINDOWPLACEMENTee = record
     ...
     _WINDOWPLACEMENTee = WINDOWPLACEMENTee;
     TWINDOWPLACEMENTee = WINDOWPLACEMENTee;
     PWINDOWPLACEMENTee = ^WINDOWPLACEMENTee;
...
begin
  ...
  try
    ...
    begin
      Result := cyImage.GraphicCreate(StoredGraphicClass);
...
begin
  ...
  FRegCustomKey := '';
  FStoreVersion := '';
  FDefinitionsLoaded := false;
  FDefinitionsSaved := false;
end;
...
begin
  ...
  case fIniDirectory of
    ...
    idCommonAppData  : Result := GetAppConfigDir(True);                    // All users application data
    idLocalAppData   : Result := GetAppConfigDir(False);                   // Current user application data
    idUserDataDir    : Result := GetUserDir;                               // Current user Dir
  end;
end;
...
var
  ...
  RAttr: RAttributes;
  WinPlacement: TWINDOWPLACEMENTee;
  RectNormalPos: TRect;
...
begin
  ...
  begin
    ...
    begin
      WinPlacement.length := SizeOf(TWINDOWPLACEMENTee);
