...
type
  ...
  public
    ...
    // Fonctions de conversion en 10θme de milimθtres :
    ...
    // Fonctions de dessin en 10θme de milimθtres :
...
// Convertir en 10θme de milimθtres ...
...
begin
  result := GetDeviceCaps(Handle, LOGPIXELSX);  // Rιcupιrer le nombre de points par pouce du Canvas ...
...
begin
  ...
  PolyBezier(pt);       // ct9999 for CodeTyphon
end;
