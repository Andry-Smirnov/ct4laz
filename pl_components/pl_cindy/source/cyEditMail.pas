...
uses
   ...
   Classes, Controls, StdCtrls, SysUtils, cyStrUtils, cyEdit;
...
begin
  ...
  begin
    ...
    for c in WebMailletters do
      Str := Str + c;
    {$ELSE}
      Str := 'abcdefghijklmnopqrstuvwxyzÈËÍ‡·‚„ÌÏÓÛÚÙı˙˘˚@._-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ…» ¡¿¬√ÕÃŒ”“‘’⁄Ÿ€';
    {$ENDIF}
...
function TcyEditMail.ValidateValue(aText: String): TEditValidateResult;
begin
  Result := evValid;
...
procedure TcyEditMail.CMExit(var Message: TLMessage);
var
  DefaultValue: String;
begin
