...
uses  LCLIntf, LCLType, LMessages,
  Classes,Messages, Controls, StdCtrls, SysUtils, cyStrUtils, cyEdit;
...
var
  ...
  RsltMaskPartOptions: TMaskOptions;
...
begin
  ...
  while GetNextMaskPart(aMask, MaskPartParamStr, MaskPartType, RsltMaskPartOptions) do
  begin
...
function TcyMaskEdit.ValidateValue(aText: String): TEditValidateResult;
begin
  if fMask = '' then
    Result := evValid
  else
