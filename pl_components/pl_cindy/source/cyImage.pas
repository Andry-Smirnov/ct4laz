...
Uses
     ...
     Graphics, Classes, SysUtils, Math,
     IntfGraphics, cyGraphics;
...
begin
  ...
  // Pre-calcul: recuperer valeurs RGB de l' ancienne et de la nouvelle palette :
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        // Recherche de la couleur de la palette qui a la plus petite variation compare a la couleur du pixel actuel :
        if a = 0
        then
          Ind := 0
        else
