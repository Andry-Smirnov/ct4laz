...
uses
     ...
     Classes, Messages, Controls, StdCtrls, SysUtils,EditBtn,
     cyStrUtils, ExtCtrls, Clipbrd, cyEdit;

type
  TcyBaseButtonedEdit = class(TEditButton)   //--- ct9999 -----------
  private
...
begin
  ...
  case CharCase of
    ...
    ecLowerCase: PressedKey := LowerCase(PressedKey);
  end;
