...
uses LCLIntf, LCLType, LMessages, cyGraphics, Classes,  Graphics, Controls;

type
  TBookmarkStyle = (bmrksNone, bmrksArrow, bmrksTriangle, bmrksLine, bmrksRectangle, bmrksCirle, bmrksPicture);
  ...
  protected
    ...
    property Style: TBookmarkStyle read FStyle write SetBookmarkStyle default bmrksArrow;
