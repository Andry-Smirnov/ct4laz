...
uses  LCLIntf, LCLType, LMessages,
      Classes,Controls, StdCtrls, SysUtils, cyEdit, cyMathParser;
...
procedure TcyEditInteger.SetCanParse(const Value: Boolean);
begin
  FCanParse := Value;
...
function TcyEditInteger.ValidateValue(aText: String): TEditValidateResult;
var Rslt: Integer;
begin
  Result := evValid;
...
// 2018-10-04 :
procedure TcyEditInteger.ValidateText;
var
...
begin
  if FCanParse then
    ...
    begin
      ...
      if Parser.Parse
      then Value := Round(Parser.ParserResult)
