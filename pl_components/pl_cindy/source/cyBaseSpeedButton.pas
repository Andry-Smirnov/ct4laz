...
uses LCLIntf, LCLType, LMessages,
     Classes, Graphics,  Messages, StdCtrls, Controls, Buttons, Dialogs, cyTypes, cyGraphics;
...
type
  ...
  private
    ...
    procedure CMMouseEnter(var Message: TLMessage); message CM_MOUSEENTER; // ct9999 for CodeTyphon
    procedure CMMouseLeave(var Message: TLMessage); message CM_MOUSELEAVE; // ct9999 for CodeTyphon
...
procedure TcyBaseSpeedButton.CMMouseLeave(var Message: TLMessage);
begin
  Inherited;
...
var SizeNeed, TextSize: Integer;
      ...
      begin
       ...
       // CalcFlags := DrawTextBiDiModeFlags(CalcFlags);   6666
