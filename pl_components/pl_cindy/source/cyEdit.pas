...
uses  LCLIntf, LCLType, LMessages,
      Classes, Controls, StdCtrls, SysUtils, cyStrUtils, ExtCtrls, Clipbrd;
...
type
  ...
  protected
    ...
    procedure LMPasteFromClip(var Message: TLMessage); message LM_PASTE; //=== ct9999 ====
  ...
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    function ValidateValue(aText: String): TEditValidateResult; virtual;
...
begin
  ...
  case CharCase of
    ...
    ecLowerCase: PressedKey := LowerCase(PressedKey); //=== ct9999 ====
  end;
...
procedure TcyBaseEdit.LMPasteFromClip(var Message: TLMessage);
var
  Str: string;
begin
...
begin
  Result := ValidateValue(Text) = evValid;
end;

function TcyAdvBaseEdit.ValidateValue(aText: String): TEditValidateResult;
begin
  Result := evValid;
end;
...
begin
  ...
  begin
    case Rslt of // 2018-10-04 ... case ValidateValue(Text) of
      evInvalidValue:
