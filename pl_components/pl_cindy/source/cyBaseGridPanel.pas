...
uses LCLIntf, LCLType, LMessages,
   ...
   Classes,Themes, Graphics, StdCtrls, ExtCtrls, Controls, Messages, Dialogs,
   cyTypes, cyClasses, cyGraphics,cyBaseExtCtrls;
...
procedure tcyBaseGridPanel.DrawBackground(const aRect: TRect);
begin
...
procedure tcyBaseGridPanel.CMMouseEnter(var Message :TLMessage);
begin
  inherited;
  MouseEnter(Self);
end;

procedure tcyBaseGridPanel.CMMouseLeave(var Message :TLMessage);
begin
  inherited;
  MouseLeave(Self);
end;
