...
uses LCLIntf, LCLType, LMessages,
     StdCtrls, Graphics, classes,  Messages, Controls, DB, DBCtrls, cyLabel;
...
begin
  ...
  begin
    if Value and FDataLink.DataSourceFixed then DatabaseError('ERROR: DataSource is Fixed');
...
procedure TcyDBLabel.CMGetDataLink(var Message: TLMessage);
begin
