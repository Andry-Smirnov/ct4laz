...
uses
    ...
    SysUtils, StdCtrls, Graphics, classes, Messages, Controls, DB,
    DBCtrls, cyStrUtils;
  ...
  if FDataLink.Field <> nil then
    case FDataLink.Field.DataType of
      ...
      begin
        ...
        else Result := ansiLowerCase(FDataLink.Field.Text) = ansiLowerCase(FValueOn);
      end;
      ...
      begin
        ...
        else Result := FDataLink.Field.AsFloat = String_ToFloat(FValueOn);        // Handle negative values :) !
      end;
...
//=== ct9999 ====
procedure TcyDBRadioButton.CNCommand(var TheMessage: TLMCommand);
begin
