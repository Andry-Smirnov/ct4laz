...
uses   LCLIntf, LCLType, LMessages,
      SysUtils, StdCtrls, Graphics, classes,  Messages, Controls, {DBConsts,} DB,
...
type
  ...
  protected
    procedure CMButtonPressed(var Message: TLMessage); //override;
...
procedure TcyDBLed.CMGetDataLink(var Message: TLMessage);
begin
...
procedure TcyDBLed.CMButtonPressed(var Message: TLMessage);
var
  Sender: TcyDBLed;
begin
