...
uses LCLIntf, LCLType, LMessages,
     Classes, Graphics,  Types, Messages, Controls, ExtCtrls, Forms, cyTypes, cyClasses, cyGraphics;

type
  NaturalNumber=integer; // ct9999
  TcySplitter = class;
...
//    property ParentColor;
    ...
    property OnDetermineHandledControl: TProcOnDetermineHandledControl read FOnDetermineHandledControl write FOnDetermineHandledControl;
...
begin
  ...
  with P do
    Rectangle(FLineDC, X, Y, Width, Height);
...
begin
  // ct9999 Old Code
  //FLineDC := GetDCEx(FDrawMotionControl.Handle, 0, DCX_CACHE or DCX_CLIPSIBLINGS or DCX_LOCKWINDOWUPDATE);

  FLineDC := GetDC(FDrawMotionControl.Handle); // ct9999
...
begin
  ...
  begin
    ...
    then begin
     ...
     with GetParentForm(Self) do  // use GetParentForm
