...
uses Classes, LCLIntf, LCLType, LMessages,
     Types, SysUtils, Controls, Graphics, cyClasses, cyTypes, cyGraphics, cyImage;
...
(* Also work but still as slow as FOriginalPage.Assign(withGraphic) ...
  FOriginalPage.Width := withGraphic.Width;
  FOriginalPage.Height := withGraphic.Height;
  FOriginalPage.Canvas.Draw(0, 0, withGraphic);
*)
...
begin
  ...
  cyGraphics.DrawGraphic(ToCanvas, PageRect, PageBmp, PageBmp.Transparent, bgStyle, bgCentered);
end;
...
begin
  ...
  cyGradientFill(Canvas, TmpRect, FLeftPageView.FPaperColor, FLeftPageView.FPaperShadeColor, dgdHorizontal, 70, 0, bmNormal, 255, 100);
...
begin
  ...
  cyGradientFill(Canvas, TmpRect, FRightPageView.FPaperShadeColor, FRightPageView.FPaperColor, dgdHorizontal, 30, 0, bmNormal, 255, 100);
