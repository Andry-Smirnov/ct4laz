...
uses
  ...
  LCLIntf, LCLType, LMessages,types, SysUtils, Classes, ComCtrls,
  StdCtrls,
...
type
  ...
  private
    ...
    FTextEditor             : TMemo;                // pointer to an external text editor for loading Type layers
    FVisibleLayerIndexArray : array of Integer;
  public
    constructor Create(AChannelManager: TgmCustomChannelManager;
      ALayerListBeforeMergence: TgmLayerList; ATextEditor: TMemo;
  ...
  public
    constructor Create(AChannelManager: TgmCustomChannelManager;
      ALayerList: TgmLayerList; APathList: TgmPathList; ATextEditor: TMemo;
  ...
  public
    constructor Create(const ACommandName: string;
      ...
      APathList: TgmPathList; ATextEditor: TMemo; const ACropRect: TRect;
...
constructor TgmLayerMergenceCommand.Create(
  ...
  ATextEditor: TMemo; const AMergeMode: TgmMergeMode);
var
  i             : Integer;
  LIndex        : Integer;
  LCommandName  : string;
...
constructor TgmRotateCanvasCommand.Create(
  AChannelManager: TgmCustomChannelManager; ALayerList: TgmLayerList;
  APathList: TgmPathList; ATextEditor: TMemo; const ARotateDegrees: Integer;
