...
uses
  LCLIntf, LCLType, LMessages,types, Graphics, GR32;

type


  TgmPrintValues = (mmPixel, mmLoEnglish ,mmLoMetric );
  ...
  Function ConvertUnits(LLoMetricValue, LDPI:integer; mmLoMetric, mmPixel:TgmPrintValues):LongInt;
