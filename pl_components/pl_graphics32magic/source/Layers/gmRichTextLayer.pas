...
type
  ...
  public
    ...
    procedure AssociateTextEditor(AEditor: TMemo);
    ...
    property AssociatedTextEditor : TMemo         read FAssociatedTextEditor;
...
procedure TgmRichTextLayer.AssociateTextEditor(AEditor: TMemo);
begin
...
begin
  ...
  Result := PtInRect(LRect, ATestPoint);
end;
