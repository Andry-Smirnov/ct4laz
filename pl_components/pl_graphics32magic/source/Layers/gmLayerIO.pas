...
function LoadLayersFromStream(
  AStream: TStream; ALayerList: TgmLayerList; ATextEditor: TMemo;
...
type
  ...
  protected
    FTextEditor  : TMemo;     // pointer to an external text editor for Rich Text Layer
...
constructor TgmCustomLayerLoader.Create(AStream: TStream;
  ALayerList: TgmLayerList; ATextEditor: TMemo);
begin
  inherited Create();
