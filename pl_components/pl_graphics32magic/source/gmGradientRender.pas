    ...
    try
      ...
      begin
        ...
        begin
          ...
          // at first quadrant
          LTopRightPoint := FixedPoint(Integer(AStartPoint.X + LXValue), AStartPoint.Y - LYValue);

          // at third quadrant
          LBottomLeftPoint := FixedPoint(Integer(AStartPoint.X - LXValue), AStartPoint.Y + LYValue);

          // at second quadrant
          LTopLeftPoint := FixedPoint(Integer(AStartPoint.X - LYValue), AStartPoint.Y - LXValue);

          // at forth quadrant
          LBottomRightPoint := FixedPoint(Integer(AStartPoint.X + LYValue), AStartPoint.Y + LXValue);
        end
        else
        // Left Slope
        if ( (AStartPoint.X > AEndPoint.X) and (AStartPoint.Y > AEndPoint.Y) ) or
        ...
        begin
          ...
          // at first quadrant
          LTopRightPoint := FixedPoint(Integer(AStartPoint.X + LYValue),
                                       AStartPoint.Y - LXValue);

          // at third quadrant
          LBottomLeftPoint := FixedPoint(Integer(AStartPoint.X - LYValue),
                                         AStartPoint.Y + LXValue);

          // at second quadrant
          LTopLeftPoint := FixedPoint(Integer(AStartPoint.X - LXValue),
                                      AStartPoint.Y - LYValue);

          // at forth quadrant
          LBottomRightPoint := FixedPoint(Integer(AStartPoint.X + LXValue),
                                          AStartPoint.Y + LYValue);
        end;
