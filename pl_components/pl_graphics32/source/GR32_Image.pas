...
uses
  ...
  GR32_AllStrings,
  GR32, GR32_Layers, GR32_RangeBars, GR32_Containers,
  GR32_RepaintOpt,
  GR32_MicroTiles, GR32_XPThemes;
...
//=== ct9999 for CodeTyphon studio ========             
  ...
  SetInitialBounds(0,0,140,140);  //=== ct9999 for CodeTyphon studio =====
//=========================================
end;
...
begin
  ...
  self.SetInitialBounds(0,0,140,140);  //=== ct9999 for CodeTyphon studio =====
...
begin
  ...
  BeginUpdate;
  if not Centered and (HScroll<>nil) and (VScroll<>nil) then  //=== ct9999 for CodeTyphon Studio ====
  begin
