...
@LoopStart:
        MOVZX   EBX, word ptr [ESI + 4 * ECX]
        MOVZX   EAX, word ptr [EBP + $0B]               // EAX = C.A
        IMUL    EBX, EAX                       // EBX = Alpha

        MOVZX   EAX, word ptr [EDI + 4 * ECX]
        MOVZX   EDX, word ptr [EBP + $08]               // EDX = C.R
        SUB     EDX, EAX
        IMUL    EDX, EBX
        SHL     EAX, $10
        ADD     EDX, EAX
        ...
        MOVZX   EAX, word ptr [EDI + 4 * ECX + 1]
        MOVZX   EDX, word ptr [EBP + $09]               // EDX = C.G
        SUB     EDX, EAX
        IMUL    EDX, EBX
        SHL     EAX, $10
        ADD     EDX, EAX
        ...
        MOVZX   EAX, word ptr [EDI + 4 * ECX + 2]
        MOVZX   EDX, word ptr [EBP + $0A]               // EDX = C.B
        SUB     EDX, EAX
        IMUL    EDX, EBX
        SHL     EAX, $10
        ADD     EDX, EAX
        ...
        MOVZX   EAX, word ptr [EDI + 4 * ECX + 3]
        MOVZX   EDX, word ptr [EBP + $0B]               // EDX = C.A
        SUB     EDX, EAX
        IMUL    EDX, EBX
        SHL     EAX, $10
        ADD     EDX, EAX
...
@LoopStart:
        MOVZX   R9D, word ptr [R10 + 4 * R8]
        MOVZX   ECX, word ptr [EBP + $0B]               // ECX = C.A
        IMUL    R9D, ECX                       // R9D = Alpha

        MOVZX   ECX, word ptr [R11 + 4 * R8]
        MOVZX   EDX, word ptr [EBP + $08]               // EDX = C.R
        SUB     EDX, ECX
        IMUL    EDX, R9D
        SHL     ECX, $10
